...
const faqItems = [
  ...
  { question: "Faut-il avoir de l'experience pour commencer ?", answer: "Absolument pas ! Nos cours sont accessibles a tous les niveaux, des debutants aux avances. Votre instructrice adapte chaque exercice en fonction de votre condition physique. Nous recommandons de commencer par une seance decouverte." },
